...
import com.company.appr.entity.HasProcessState;
    ...
    public void onEvent(ActivitiEvent event) {
        ...
        switch (event.getType()) {
            case ACTIVITY_STARTED:
                ...
                String activityType = ((ActivitiActivityEvent) event).getActivityType();
                if (!Strings.isNullOrEmpty(activityName) && !"serviceTask".equals(activityType)) {
