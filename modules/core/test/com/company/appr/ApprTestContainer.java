...
public class ApprTestContainer extends TestContainer {

    public ApprTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/appr/app.properties",
    ...
    public static class Common extends ApprTestContainer {

        public static final ApprTestContainer.Common INSTANCE = new ApprTestContainer.Common();
